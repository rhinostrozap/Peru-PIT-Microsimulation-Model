...
def initialize_vars(self):
    ...
    self.vars['pit_data_filename'] = "sample_data.csv"
    ...
    self.vars['pit_functions_filename'] = "functions_pit_peru.py"
    self.vars['pit_function_names_filename'] = "function_names_pit_peru.json"
    self.vars['pit_distribution_json_filename'] = 'pit_distribution_peru.json'  
    self.vars['gdp_filename'] = 'gdp_nominal_peru.csv'
    ...
    self.vars['start_year'] = 2019
    self.vars['end_year']=2027
    self.vars['pit_data_start_year'] = 2019
...
def display_entry(self, widget, tax_type):
    ...
    if not self.vars[tax_type]:
        ...
        if tax_type == 'pit':
            ...
            self.vars['GROWFACTORS_FILENAME'] = "growfactors_pit_peru.csv"
            self.vars['start_year'] = 2019
            self.vars['data_start_year'] = 2019
            self.vars['SALARY_VARIABLE'] = "SALARY"
